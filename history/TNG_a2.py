...
def rothalo(coor, Jz):
    ...
    '''
    rot = RotMatrix(np.linalg.norm(Jz))
...
def SelectDisk(snap_num):
    ...
    halolen = il.func.loadSubhalos('TNG', 99, 'SubhaloLenType')[:, 4]
...
#
def subhaloA2(dir=' ', StellarHalfmassRads, SubhaloPositions):
    ...
    #It's a list about A2 parameter, sorted by distance between halo and center
    return A2_R = (a2_R**2 + b2_R**2)**0.5 / a0
