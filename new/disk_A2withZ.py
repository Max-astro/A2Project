...
def il1_unbarA2():
    ...
    count = 0
    for subhaloID in unbar:
        f = open('/Raid0/zhouzb/csv/diskA2_il1.csv', 'a', newline='')
        f_csv = csv.writer(f)
        A2 = []
        ...
        for snapnum in snapshot:
            ...
            try:
                ...
                A2.append(-1)
                continue
            A2.append(subhaloA2('il1', haloID, snapnum))
...
def TNG_unbarA2():
    ...
    diskID = np.load('/Raid0/zhouzb/TNG/diskID_4WP.npy')
    ...
    count = 0
    for subhaloID in unbar:
        f = open('/Raid0/zhouzb/csv/diskA2_TNG.csv', 'a', newline='')
        f_csv = csv.writer(f)
        A2 = []
        ...
        for snapnum in snapshot:
            ...
            try:
                ...
                A2.append(-1)
                continue
            A2.append(subhaloA2('TNG', haloID, snapnum))
